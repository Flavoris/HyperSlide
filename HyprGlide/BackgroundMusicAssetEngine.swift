...
//  HyprGlide
//
//  Plays the bundled HyprGlide soundtrack on loop using AVAudioPlayer.
//
...
/// (`HyprGlide Music.mp3`) with gentle fade out/in at loop points.
final class BackgroundMusicAssetEngine: NSObject, BackgroundMusicControlling {
    
    private let queue = DispatchQueue(label: "HyprGlide.BackgroundMusicAssetEngine")
    ...
    init(bundle: Bundle = .main,
         resourceName: String = "HyprGlide Music",
