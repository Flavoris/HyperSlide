...
#ifndef HYPRGLIDE_SWIFT_H
#define HYPRGLIDE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HyprGlide",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

/// Lightweight wrapper around <code>AVAudioPlayer</code> that loops the shipped soundtrack
/// (<code>HyprGlide Music.mp3</code>) with gentle fade out/in at loop points.
SWIFT_CLASS("_TtC9HyprGlide26BackgroundMusicAssetEngine")
@interface BackgroundMusicAssetEngine : NSObject
...
@class UIEvent;
@class NSCoder;
SWIFT_CLASS("_TtC9HyprGlide9GameScene")
...
SWIFT_CLASS("_TtC9HyprGlide18MultiplayerManager")
...
@class GKPlayer;
@class GKInvite;
@interface MultiplayerManager (SWIFT_EXTENSION(HyprGlide)) <GKLocalPlayerListener>
...
@class GKMatch;
@interface MultiplayerManager (SWIFT_EXTENSION(HyprGlide)) <GKMatchmakerViewControllerDelegate>
...
@class NSData;
@interface MultiplayerManager (SWIFT_EXTENSION(HyprGlide)) <GKMatchDelegate>
...
SWIFT_CLASS("_TtC9HyprGlide12ObstacleNode")
@interface ObstacleNode : SKShapeNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

/// Glowing collectible ring or shape that grants a temporary effect.
SWIFT_CLASS("_TtC9HyprGlide11PowerUpNode")
